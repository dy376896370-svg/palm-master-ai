...
const palmLineAnalysisSchema = z.object({
  ...
  approximatePosition: z.string().min(20),
  visibilityAssessment: z.string().min(35),
  visibilityIssue: z.string().min(35),
  visibleFeature: z.string().min(30),
  isClearlyVisible: z.boolean(),
  referenceBasis: z.string().min(35),
  traditionalGeneralInterpretation: z.string().min(90),
  westernGeneralInterpretation: z.string().min(90),
  combinedReading: z.string().min(90),
  practicalAdvice: z.string().min(55),
  selfObservationQuestion: z.string().min(20),
...
const palmReportBaseSchema = z.object({
  ...
  overallImpression: z.object({
    ...
    culturalReading: z.string().min(80),
    modernReflection: z.string().min(80),
  }),
  ...
  share: z.object({
    title: z.string(),
    summary: z.string().min(55),
    oneLineSummary: z.string().min(16),
