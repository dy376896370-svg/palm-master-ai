...
const palmLineAnalysisSchema = z.object({
  ...
  approximatePosition: z.string().min(12),
  visibilityAssessment: z.string().min(18),
  visibilityIssue: z.string().min(18),
  visibleFeature: z.string().min(18),
  isClearlyVisible: z.boolean(),
  referenceBasis: z.string().min(20),
  traditionalGeneralInterpretation: z.string().min(48),
  westernGeneralInterpretation: z.string().min(48),
  combinedReading: z.string().min(60),
  practicalAdvice: z.string().min(32),
  selfObservationQuestion: z.string().min(12),
...
const palmReportBaseSchema = z.object({
  ...
  overallImpression: z.object({
    ...
    culturalReading: z.string().min(45),
    modernReflection: z.string().min(45),
  }),
